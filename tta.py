# code taken from https://github.com/junkoda/kaggle_contrails_solution/blob/main/src/submit/unet5/tta.py
"""
...
def _tta_average(y_pred: torch.Tensor, n: int, prob: bool) -> torch.Tensor:
    ...
    y_avg = torch.zeros((batch_size, 13, H, W), dtype=torch.float32, device=y_pred.device)
...
class TTA:
    ...
    """
    def __init__(self, num_tta): #, tta_str: str
        self.n, self.prob = (num_tta, False) # (4, False) (8, False) #_tta_config[tta_str]
